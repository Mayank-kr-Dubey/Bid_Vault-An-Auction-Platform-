                ...
                return (
                  <tr key={element._id}>
                    ...
                    <td className="py-2 px-4 flex space-x-2">
                      <Link to={`/auction/details/${element._id}`} className="btn btn-outline text-sm">
                        View
                      </Link>
                      <button className="btn btn-destructive text-sm" onClick={() => handleAuctionDelete(element._id)}>
                        Delete
                      </button>
                    </td>
                  </tr>
