    ...
    <>
      <section className="my-8">
        ...
        <div className="flex flex-wrap gap-6">
          <div  className="bg-card w-full p-2 gap-10 rounded-md flex flex-col justify-between lg:flex-1 lg:h-auto lg:p-6 2xl:flex-none 2xl:basis-64 2xl:flex-grow 2xl:px-2  2xl:py-6 border border-border">
            <span className="rounded-full bg-primary text-primary-foreground w-fit p-3">
              <RiAuctionFill />
            </span>
            <div>
            ...
            {auctionsStartingToday.slice(0, 2).map((element) => {
              return (
                ...
                to={`/auction/item/${element._id}`}
                  key={element._id}
                  className="w-full flex flex-col gap-4 card p-2 rounded-md 2xl:gap-2 hover:shadow-md transition-all duration-300"
                >
